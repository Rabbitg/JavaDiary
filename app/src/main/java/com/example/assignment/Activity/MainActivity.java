...
//                db.execSQL("insert into tb_memo(title, content, now_emoticon_state) values(?,?,?)",
//                        new String[]{title, content, now_emoticon_state} );
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        //currentDateString = SimpleDateFormat.getDateInstance(DateFormat.FULL).format(c.getTime());
